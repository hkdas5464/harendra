...
const SidebarHeader = () => {
  return (
    <div className="flex space-x-2">
      <Image
        src="https://lh3.googleusercontent.com/pw/AP1GczOPUnVf6DeDeTWnJSDBDcSGy_qe9RW483lT6bYRzjNM7W6llepaUGutYXiGDCzV_WaShgzbIJ4SD4p-1ZinZx1h6XTsslza8tuZJdPypKJHw1Jw-VbtJIEjkalMfjdee4BfIkYifAW_zVX11yWj-6fK=w715-h913-s-no-gm?authuser=0"
        alt="Avatar"
        height="40"
        width="40"
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Harendra Das</p>
